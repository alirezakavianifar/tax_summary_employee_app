...
3. **`FinalityStage` (مرحله قطعیت پرونده مالیاتی):**
   - `Tamkin` (تمکين)
   - `Agreement` (توافق)
   - `PrimaryBoard244` (رای هیات بدوی 244)
   - `AppellateBoard247` (رای هیأت تجدیدنظر 247)
   - `SupremeTaxCouncil251` (شورای عالی مالیاتی 251)
   - `Board251Repeated` (هیات 251 مکرر)
   - `Board257` (هیات 257)
   - `Board216` (هیات 216)
   - `ParallelBoard` (هیات هم عرض)
4. **`RefundCaseStatus`:**
   - `Draft` (پیش‌نویس)
